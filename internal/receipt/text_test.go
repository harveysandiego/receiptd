...
func TestTextValidate(t *testing.T) {
	tests := []struct {
		...
		{"align omitted (left, default)", receipt.Text{Content: "Milk", Align: ""}, false},
		{"align left", receipt.Text{Content: "Milk", Align: "left"}, false},
		{"align center", receipt.Text{Content: "Milk", Align: "center"}, false},
		{"align right", receipt.Text{Content: "Milk", Align: "right"}, false},
		{
			"align outside the closed enum is rejected",
