...
func TestAssetValidate(t *testing.T) {
	tests := []struct {
		...
		{"align omitted (left, default)", receipt.Asset{Name: "logo.png", Align: ""}, false},
		{"align left", receipt.Asset{Name: "logo.png", Align: "left"}, false},
		{"align center", receipt.Asset{Name: "logo.png", Align: "center"}, false},
		{"align right", receipt.Asset{Name: "logo.png", Align: "right"}, false},
		{"align outside the closed enum is rejected", receipt.Asset{Name: "logo.png", Align: "diagonal"}, true},
