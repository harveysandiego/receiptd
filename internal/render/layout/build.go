...
// becomes one Block, stacked top to bottom in Receipt order, each Y
// advancing by f.LineHeight(). The returned Document carries f, so every
...
// Content. Element types other than receipt.Text and receipt.Heading are
// not yet supported and are reported as an apperr.KindPermanent error
